...
g.finishSheepApi = "https://cat-match.easygame2021.com/sheep/v1/game/game_over_ex?rank_score=1&rank_state=1&rank_time=%s&rank_role=1&skin=%s&t=%s"
...
def finishGameSheep(context):
    ...
    finishBody = {"rank_score": 1, "rank_state": 1, "rank_time": costTime, "rank_role": 1, "skin": 1,
"MatchPlayInfo": "CAMiBQjnARAAIgYI5gEQ2wEiBgiAAhDWASIGCP8BEN8BIgYInwIQsAQiBgieAhCQAyIGCJwCENEH"}
    res = requests.post(g.finishSheepApi % (costTime, args.skin, args.inputData1), headers=g.requestHeader, json=finishBody, timeout=10, verify=False)
